...
static int lunix_chrdev_state_needs_refresh(struct lunix_chrdev_state_struct *state){
	...
	WARN_ON ( !(sensor = state->sensor)); //macro εντολή για να βρούμε bugs στο δικό μας κώδικα ή προβλήματα στο hardware
